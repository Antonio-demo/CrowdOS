...
import com.example.util.SM2EncDecUtils;
...
//        sensor_message.setTaskId(taskId);
        ...
        String cipherresult = SM2EncDecUtils.encrypt(Util.hexToByte(pubk), result);
        ...
        result = new String(SM2EncDecUtils.decrypt(Util.hexToByte(prik), Util.hexToByte(cipherresult)));
